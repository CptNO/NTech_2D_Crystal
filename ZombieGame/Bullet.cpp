...
void Bullet::draw(NTCrystal::SpriteBatch &spriteBatch)
{
	...
	spriteBatch.draw(destRect, uvRect, NTCrystal::ResourceManager::getTexture("Textures/Bullet.png").id, 0.0f, color);
...
bool Bullet::collideWithWorld(const std::vector<std::string> &levelData){
	...
	return (levelData[gridPosition.y][gridPosition.x] != '.' && levelData[gridPosition.y][gridPosition.x] != ',');
